...
// TASK 4 --- Greatest Increase in Profits/Losses
// var greatestIncrease = finances[0];
// for (var i=0; i<finances.length; i++){
...
var leastIncrease = ['', 9999999999]

for (var i = 0; i < finances.length; i++) {
  for (let m = 0; m < finances[i].length; m++) {
    if (typeof finances[i][m] !== 'string') {
